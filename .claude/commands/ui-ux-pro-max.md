...
| Rule | Standard | Avoid |
|------|----------|-------|
| No Emoji as Structural Icons | Use vector-based icons (Lucide, Heroicons) | Emojis for navigation, settings, or system controls |
...
| Rule | Do | Don't |
|------|----|----- |
| Safe-area compliance | Respect top/bottom safe areas for all fixed elements | Placing fixed UI under notch or gesture area |
